...
- This can be accomplished using secure copy or scp: `scp .ssh/id_rsa.pub {destination} username@IPaddress:/path/to/file` OR ssh-copy-id -i id_rsa.pub server2 (or whatever name you put into the known_host file)
